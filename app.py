# from smolagents import CodeAgent,DuckDuckGoSearchTool, HfApiModel,tool ,load_tool
from smolagents import CodeAgent, DuckDuckGoSearchTool, InferenceClientModel, tool, load_tool
import datetime
import requests
import pytz
import yaml
...
def get_weather(city:str)-> str: #it's import to specify the return type
    ...
    """This tool help to get weather for a given city.
    Args:
    ...
    try:
        ...
        return f"Failed to retrieve weather for {city}: {str(e)}"
